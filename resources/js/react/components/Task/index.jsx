...
export default class ShowTask extends Component {
    ...
    showInfo = (
        <div className="col-12 col-md-8 offset-md-4 float-left show-tasks-container">
                ...
                <div className="employees-container task-detail next-line">
                    <div className="user-dropdown-item border-sharp animated jackInTheBox permanent-visible">
                        ...
                        <div className="user-label-container">
                            <button className="btn btn-sm btn-success rtl admin"><span><i className="fas fa-star ml-1"></i>ادمین<i className="fas fa-user-tie mr-1"></i></span></button>
                        </div>
                    </div>
                </div>
            </div>
