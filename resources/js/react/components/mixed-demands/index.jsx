...
export default class MixedDemands extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({[current_tab]: {data: [], nextPage: 1, hasMore: true}, gettingInitialData: true}, () => this.getData())
    ...
    render() {
        let { demands, needs, isGetting, already_added_needs, workspaces, workspaces_users, selected_workspace, gettingInitialData } = this.state, { logged_in_user_id, demand_show_route } = this.props
        return (
            <div>
                {gettingInitialData
